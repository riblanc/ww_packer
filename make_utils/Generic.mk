...
MK = Makefile make_utils/Common.mk make_utils/Generic.mk
...
$(OBJ_DIR)/$(NAME):
	...
	$(foreach n,                                                               \
		$(shell find $(SRC_DIR) -type d -not -path $(SRC_DIR)),                \
		mkdir -p $(OBJ_DIR)/$(NAME)/$(subst $(SRC_DIR)/,,$n);                  \
	)
